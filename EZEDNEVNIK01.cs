...
class Program
{
    ...
    {
        new Note("Заметка 1", "Описание заметки 1", new DateTime(2023,10,13)),
        new Note("Заметка 2", "Описание заметки 2", new DateTime(2023,10,13)),
        new Note("Заметка 3", "Описание заметки 3", new DateTime(2023,10,13)),
        new Note("Заметка 4", "Описание заметки 4", new DateTime(2023,10,13)),
        new Note("Заметка 5", "Описание заметки 5", new DateTime(2023,10,13)),
    };
